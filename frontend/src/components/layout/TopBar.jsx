...
export default function TopBar({ user, onMenuClick }) {
  ...
  return (
    <header className="h-14 sm:h-16 border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 flex items-center justify-between gap-2 px-3 sm:px-6 sticky top-0 z-30">
      <div className="flex items-center gap-2 min-w-0">
        <button
          type="button"
          className="lg:hidden inline-flex h-9 w-9 items-center justify-center rounded-lg hover:bg-muted text-muted-foreground"
          onClick={onMenuClick}
        ...
        <div className="min-w-0">
          ...
          <p className="text-[10px] sm:text-xs text-muted-foreground/80 truncate hidden xs:block sm:block">
      ...
      <div className="flex items-center gap-1 sm:gap-2 shrink-0">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-1.5 sm:px-2 py-1.5 hover:bg-muted transition-colors"
          >
            ...
            <div className="absolute right-0 mt-2 w-64 rounded-xl border border-border bg-card shadow-lg overflow-hidden z-50">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-background border border-border shadow flex items-center justify-center hover:bg-muted disabled:opacity-50"
              ...
              <div className="py-1">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-4 py-2.5 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 transition-colors"
                >
