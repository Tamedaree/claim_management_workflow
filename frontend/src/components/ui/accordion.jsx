...
const AccordionItem = React.forwardRef(
   ...
   * @param {React.Ref<React.ElementRef<typeof AccordionPrimitive.Item>>} ref
   */
  ({ className, ...props }, ref) => (
...
const AccordionTrigger = React.forwardRef(
   ...
   * @param {React.Ref<React.ElementRef<typeof AccordionPrimitive.Trigger>>} ref
   */
...
const AccordionContent = React.forwardRef(
   ...
   * @param {React.Ref<React.ElementRef<typeof AccordionPrimitive.Content>>} ref
   */
  ({ className, children, ...props }, ref) => (
