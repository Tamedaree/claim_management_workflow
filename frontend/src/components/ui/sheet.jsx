...
const SheetOverlay = React.forwardRef(
   ...
   * @param {React.Ref<React.ElementRef<typeof SheetPrimitive.Overlay>>} ref
   */
  ({ className, ...props }, ref) => (
...
const SheetContent = React.forwardRef(
   ...
   * @param {React.Ref<React.ElementRef<typeof SheetPrimitive.Content>>} ref
   */
...
const SheetTitle = React.forwardRef(
   ...
   * @param {React.Ref<React.ElementRef<typeof SheetPrimitive.Title>>} ref
   */
  ({ className, ...props }, ref) => (
...
const SheetDescription = React.forwardRef(
   ...
   * @param {React.Ref<React.ElementRef<typeof SheetPrimitive.Description>>} ref
   */
  ({ className, ...props }, ref) => (
